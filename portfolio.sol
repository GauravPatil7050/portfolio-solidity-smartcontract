...
contract Portfolio{
  ...
  string public imageLink="Add your image link from pinata";
  string public description="1 year experience in blockchain development ";
  string public resumeLink="Add resume link from pinata";
  uint projectCount;
  uint educationCount;
  ...
  modifier onlyManager(){
      require(manager==msg.sender,"manager required");
      _;
  }
